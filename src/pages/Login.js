...
import LoginImg from "../assets/1299051.svg"
...
function LogIn() {
    ...
    return (
        <div className="relative">
            ...
            <div className="z-20 p-4 m-8 origin-bottom-right transform border-4 border-secondary lg:mx-56 md:mx-8 lg:-mt-80 rounded-2xl bg-tertiary">
                <div className="p-4 space-y-10 md:space-y-0 md:grid md:grid-cols-2">

                    <div className="w-11/12 p-8 rounded-lg lg:-ml-4 sm:ml-16">
                        <img width="600" height="600" src={LoginImg} alt="img" />
                    </div>
                        ...
                        <div className='grid place-items-center'>
                            <div className="w-60 h-60 my-5 block bg-white hover:bg-gray-100 focus:bg-gray-100 text-gray-900 font-semibold rounded-lg px-4 py-3 border border-gray-300 cursor-pointer shadow-lg">
                                <div className="flex items-center justify-center h-full bg-white hover:bg-gray-100" onClick={() => handleAuth(4, true)}>
                                    ...
                                    <span className="ml-2 text-2xl">Sign in with DeSo</span>
                                </div>
                            </div>
                        </div>
